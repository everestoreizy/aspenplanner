...
public class TempData {
    ...
    public static void addTask(String owner, String tag, int timeslotId, String content) {
        findTimeslot(owner, tag, timeslotId).tasks.add(new Task(content));
    }

    public static void removeTask(String owner, String tag, int timeslotId, int taskId) {
        findTimeslot(owner, tag, timeslotId).tasks.remove(taskId);
    }
}
